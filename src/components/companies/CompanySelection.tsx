...
export const CompanySelection: React.FC = () => {
  ...
  const handleCompanySelect = async (companyId: string) => {
    ...
    try {
      let companyName = 'GlobalAuto Rentals';
  ...
  // Check if user can see "All Companies" option (admin and manager only)
  const canSeeAllCompanies = user?.role === 'admin' || user?.role === 'manager';
  ...
  if (loading.error) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center" style={{ borderColor: '#E3E5EA' }}>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Part of Global Fleet Management
                        </p>
                      </div>
